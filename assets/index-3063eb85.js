...
`,lang:"javascript"};const cl=Ue({name:"DocumentBody",props:{editorTheme:{type:String,default:"light"}},setup(e){return()=>E("section",{class:"body-wrapper"},[E("div",{class:"body-editor-wrapper"},[E(Qa,{height:"500px",theme:e.editorTheme,language:"javascript",value:ll},null)]),E("div",{class:"body-description"},[E("span",null,[ve("Editor 👆")]),E("span",null,[ve("👇 Diff Editor")])]),E("div",{class:"body-diff-editor-wrapper"},[E(nl,{height:"500px",theme:e.editorTheme,language:gn.lang,original:gn.original,modified:gn.modified},null)])])}});const ul=Ue(()=>{const e=Jn(!0),t=Te(()=>e.value?"vs-dark":"vs");return()=>E(de,null,[E(il,{class:"page-dark-mode",onChange:n=>e.value=n},null),E(sl,{class:"page-github-corners",href:"https://github.com/imguolao/monaco-vue"},null),E(al,null,null),E(cl,{editorTheme:t.value},null)])});Tn.config({paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.43.0/min/vs"}});oa(ul).mount("#app");
