...
`,lang:"javascript"};const dl=Ue({name:"DocumentBody",props:{editorTheme:{type:String,default:"light"}},setup(e){return()=>N("section",{class:"body-wrapper"},[N("div",{class:"body-editor-wrapper"},[N(tl,{height:"500px",theme:e.editorTheme,language:"javascript",value:fl},null)]),N("div",{class:"body-description"},[N("span",null,[ve("Editor 👆")]),N("span",null,[ve("👇 Diff Editor")])]),N("div",{class:"body-diff-editor-wrapper"},[N(sl,{height:"500px",theme:e.editorTheme,language:yn.lang,original:yn.original,modified:yn.modified},null)])])}});const pl=Ue(()=>{const e=Jt(!0),t=Ee(()=>e.value?"vs-dark":"vs");return()=>N(pe,null,[N(al,{class:"page-dark-mode",onChange:n=>e.value=n},null),N(ll,{class:"page-github-corners",href:"https://github.com/imguolao/monaco-vue"},null),N(ul,null,null),N(dl,{editorTheme:t.value},null)])});Sn.config({paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.54.0/min/vs"}});aa(pl).mount("#app");
